							...
							<div class="row">
								...
								<div class="input-field col s12">
									<input id="source_airport" type="text" class="validate"
										name="source_airport"
										value="${scheduledFlightData.getSchedule().getSourceAirport().getAirportLocation()}"></input>
									<label for="source_airport">Source Airport</label>
								</div>
								<div class="input-field col s12">
									<input id="destination_airport" type="text" class="validate"
										name="destination_airport"
										value="${scheduledFlightData.getSchedule().getDestinationAirport().getAirportLocation()}"></input>
