...
public class ScheduleFlightController {
		...
		public ResponseEntity<ScheduleFlight> addScheduleFlight(@ModelAttribute("scheduleFlight") ScheduleFlight scheduleFlight,
			...
			System.out.println(scheduleFlight.getScheduleFlightId());
		...
		public ResponseEntity<ScheduleFlight> searchScheduleFlight(@RequestParam BigInteger scheduleFlightId) throws FrsException{					
			ScheduleFlight searchSFlight=scheduleFlightService.viewScheduleFlights(scheduleFlightId);
		...
		public boolean deleteScheduleFlight(@RequestParam BigInteger scheduleFlightId) throws FrsException{					//removing flight
			
			boolean deleteSFlight=scheduleFlightService.deleteScheduleFlight(scheduleFlightId);
